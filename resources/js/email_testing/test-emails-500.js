/**
 * MAIKINE Email Performance Test - High Load
 *
 * Sends 500 email requests to the real MAIKINE server.
 *
 * Run with:
 * node resources/js/email_testing/test-emails-500.js
 */
...
async function runTest() {
    ...
    console.log('\n===== MAIKINE EMAIL PERFORMANCE TEST - 500 EMAILS =====');
